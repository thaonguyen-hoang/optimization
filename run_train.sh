...
# python -m scripts.train --loss bce --reg l2 --lam 1e-2 --optimizer newton --lr 1.0 --epochs 20 --loss-epsilon 1e-4 --data-dir "$DATA_DIR" --out-dir "$OUT_DIR" --save-figures
# Backtracking Armijo (Newton LUÔN ép initial_lr=1.0 để giữ hội tụ bậc 2)
# python -m scripts.train --loss bce --reg l2 --lam 1e-2 --optimizer newton --backtracking --epochs 20 --loss-epsilon 1e-4 --data-dir "$DATA_DIR" --out-dir "$OUT_DIR" --save-figures

# 1.4. STOCHASTIC GRADIENT DESCENT (SGD) (Mini-batch, không có backtracking)
# Fixed step size (Dùng --lr và --batch-size)
# python -m scripts.train --loss bce --reg none --optimizer sgd --lr 0.01 --batch-size 256 --epochs 500 --loss-epsilon 1e-4 --data-dir "$DATA_DIR" --out-dir "$OUT_DIR" --save-figures
...
# Fixed step size 
# python -m scripts.train --loss bce --reg l1 --lam 1e-2 --optimizer gd --lr 0.01 --epochs 500 --loss-epsilon 1e-4 --data-dir "$DATA_DIR" --out-dir "$OUT_DIR" --save-figures
...
# Fixed step size
# python -m scripts.train --loss bce --reg l1 --lam 1e-2 --optimizer nag --lr 0.01 --epochs 500 --loss-epsilon 1e-4 --data-dir "$DATA_DIR" --out-dir "$OUT_DIR" --save-figures
...
# 2.3. PROXIMAL SGD
# Fixed step size
# python -m scripts.train --loss bce --reg l1 --lam 1e-2 --optimizer sgd --lr 0.01 --batch-size 256 --epochs 500 --loss-epsilon 1e-4 --data-dir "$DATA_DIR" --out-dir "$OUT_DIR" --save-figures
...
# ------------------------------------------------------------------------------
# python -m scripts.train --loss bce --reg none --lam 1e-2 --optimizer gd --lr 0.01 --epochs 500 --loss-epsilon 1e-4 --data-dir "$DATA_DIR" --out-dir "$OUT_DIR" --save-figures